...
const DirectoryPage = ({ page, companies, categories, pagination }) => {
  return (
...
export async function getServerSideProps({ params, query }) {
  ...
  const {
    data: companies,
    meta: { pagination },
  } = await getCompanies(currentPage, null, filters);
  ...
  return {
    props: { page, companies, categories, footerCategories, pagination },
  };
}
